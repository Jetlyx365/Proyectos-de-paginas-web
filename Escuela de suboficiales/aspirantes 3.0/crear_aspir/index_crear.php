...
<body>
    ...
    <div id="conteiner">
        <div id="botones">
            <a href="../metadatos_crear/crear.php"><button class="crear_boton">Crear</button></a>
            <a href="../metadatos_crear/cerrar_sesion.php"><button class="cerrar_boton">Cerrar sesión</button></a>
        </div>
        <table id="tabla">
