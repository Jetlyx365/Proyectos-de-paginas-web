...
<body>
    ...
    <div id="usuario">
        <a href="crear_admins/crear_admins.php"><button class="usuario">Crear admins</button></a>
    </div>
    ...
    <div id="conteiner">
        <div id="botones">
            <a href="../metadatos_admin/crear.php"><button class="crear_boton">Crear</button></a>
            <a href="../metadatos_admin/cerrar_sesion.php"><button class="cerrar_boton">Cerrar sesión</button></a>
        </div>
        <table id="tabla">
