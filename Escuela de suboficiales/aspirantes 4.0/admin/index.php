...
<body>
    ...
    <div>
        <div id="botones">
            <a href="../metadatos_admin/crear.php"><button id="crear_boton" class="boton">Crear</button></a>
            <a href="crear_admins/crear_admins.php"><button id="crear_admin_boton" class="boton">Crear admins</button></a>
            <a href="../metadatos_admin/cerrar_sesion.php"><button id="cerrar_sesion_boton" class="boton">Cerrar sesión</button></a>
        </div>
        <table id="tabla">
