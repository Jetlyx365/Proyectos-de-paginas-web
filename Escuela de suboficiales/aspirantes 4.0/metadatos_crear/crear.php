...
<body>
    ...
    <div id="volver">
        <a href="../crear_aspir/index_crear.php"><button class="retro">Cancelar</button></a>
    </div>
    ...
    <div id="conteiner">
        ...
        <form id="imageForm" action="bd_crear.php" enctype="multipart/form-data" method="post" onsubmit="return validateImage()">
            ...
            <input type="text" name="Nombre" placeholder="Nombre" required="required" autocomplete="off">
            <input type="tel" name="DNI" placeholder="DNI" required="required" autocomplete="off">
            <input type="tel" name="Telefono" placeholder="Telefono" required="required" autocomplete="off"><br><br>
