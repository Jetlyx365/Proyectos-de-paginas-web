...
<body>
    ...
    <div>
        <div id="botones">
            <a href="../metadatos_crear/crear.php"><button id="crear_boton" class="boton">Crear</button></a>
            <a href="../metadatos_crear/cerrar_sesion.php"><button id="cerrar_sesion_boton" class="boton">Cerrar sesión</button></a>
        </div>
        <table id="tabla">
    ...
    <script>
        ...
        function fetchResults(searchTerm) {
            ...
            // Definir la devolución de llamada cuando  se escribe algo
