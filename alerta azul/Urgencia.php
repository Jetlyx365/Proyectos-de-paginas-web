...
<body>
    ...
    <div  class="form">
    <table >
        <center><h1>Registro urgencia</h1></center>
    <?php
                    $consulta ="SELECT * FROM urgencia";
...
<center><button class="css-button-shadow-border-sliding--sky"  id="create_pdf">Exportar como PDF</button></center>
